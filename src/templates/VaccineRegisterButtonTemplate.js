...
const VaccineRegisterButtonTemplate = () => {
    ...
    return (
        <LinkContainer to="/vaccine_register">
              <Button onClick={ initialRouteState } variant="warning">註冊疫苗紀錄</Button>
        </LinkContainer>
    );
};

export default VaccineRegisterButtonTemplate;
